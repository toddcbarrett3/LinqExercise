...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var lessThanFour = numbers.Where(x => x < 4).OrderBy(x => x).ToList();
            foreach (var item in lessThanFour)
            {
            ...
            newEmployee.FirstName = "Todd";
            newEmployee.LastName = "Barrett";
            newEmployee.Age = 46;
            newEmployee.YearsOfExperience = 0;
